...
public final class IndexPageOps {
     ...
     * @throws MtrStateException 如果 MTR 不在 ACTIVE 状态
     */
    private static void initInfimumSupremum(BufferFrame frame, MiniTransaction mtr) throws MtrStateException {
        // ===== Infimum 记录 =====
     ...
     * @throws MtrStateException 如果 MTR 不在 ACTIVE 状态
     */
    private static void initPageDirectory(BufferFrame frame, MiniTransaction mtr) throws MtrStateException {
     ...
     * @param mtr    Mini-Transaction
     */
    public static void setPrevPage(BufferFrame frame, int pageNo, MiniTransaction mtr)
            throws MtrStateException {
        assertXLatched(frame);
        mtr.writeInt(frame, IndexPageLayout.FIL_PAGE_PREV, pageNo);
    }
     ...
     * @param mtr    Mini-Transaction
     */
    public static void setNextPage(BufferFrame frame, int pageNo, MiniTransaction mtr)
            throws MtrStateException {
        assertXLatched(frame);
        mtr.writeInt(frame, IndexPageLayout.FIL_PAGE_NEXT, pageNo);
    }
     ...
     * @param mtr        Mini-Transaction
     */
    public static void writeRecordData(BufferFrame frame, int offset, byte[] recordData, MiniTransaction mtr) throws MtrStateException {
        assertXLatched(frame);
     ...
     * @param mtr       Mini-Transaction
     */
    public static void deleteRecord(BufferFrame frame, int prevRec, int recOffset, int recSize, MiniTransaction mtr) throws MtrStateException {
        assertXLatched(frame);
