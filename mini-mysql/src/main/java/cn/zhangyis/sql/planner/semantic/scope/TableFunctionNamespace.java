...
//        Column valueColumn = new Column("value", FiledType.BIGINT);
...
//        FiledType elementType =FiledType.VARCHAR; // 默认类型
//
...
//
//        // 简化实现：返回固定的列结构
//        Column pathColumn = new Column("path", FiledType.VARCHAR);
//        Column valueColumn = new Column("value", FiledType.VARCHAR);
//
...
//            FiledType columnType = signature.getDefaultColumnType();
//
...
//        private final FiledType defaultColumnType;
//
//        public TableFunctionSignature(String name, int minArgs, int maxArgs,
//                                    int defaultColumnCount, FiledType defaultColumnType) {
//            this.name = name;
...
//        public FiledType getDefaultColumnType() { return defaultColumnType; }
//    }
//}